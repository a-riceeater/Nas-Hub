...
export class MetricCollector extends EventEmitter {
  current:Metric|null=null; private timer?:NodeJS.Timeout; private collecting=false; private lastPersist=0; healthy=false;
